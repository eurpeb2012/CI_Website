...
const therapistTiers = {
  free: {
    ...
    features: ['tierFeatureBasicListing', 'tierFeature1Booking', 'tierFeature1Session', 'tierFeatureScheduleView'],
    maxBookings: 1,
    maxSessions: 1,
  ...
  standard: {
    ...
    features: ['tierFeature3Bookings', 'tierFeature3Sessions', 'tierFeatureScheduleEdit'],
    maxBookings: 3,
    maxSessions: 3,
  ...
  premium: {
    ...
    features: ['tierFeaturePriority', 'tierFeatureAnalytics', 'tierFeature10Sessions', 'tierFeatureScheduleEdit'],
    maxBookings: 10,
    maxSessions: 10,
    canEditSchedule: true,
    platformFee: 9,
