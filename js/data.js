...
const therapistTiers = {
  free: {
    ...
    features: ['tierFeatureBasicListing', 'tierFeature3Bookings', 'tierFeature3Sessions', 'tierFeatureScheduleView'],
    maxBookings: 3,
    maxSessions: 3,
  ...
  standard: {
    ...
    features: ['tierFeatureUnlimitedBookings', 'tierFeature10Sessions', 'tierFeatureScheduleEdit', 'tierFeature9Fee'],
  ...
  premium: {
    ...
    features: ['tierFeaturePriority', 'tierFeatureAnalytics', 'tierFeatureUnlimitedSessions', 'tierFeatureScheduleEdit', 'tierFeature9Fee'],
    maxBookings: Infinity,
