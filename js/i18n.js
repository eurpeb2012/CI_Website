const translations = {
  ja: {
    ...
    categoryPlayful: '体験・占い・リトリート',
    categoryPlayfulDesc: '楽しい体験や占い、リトリートなど',
    categoryExperiences: '体験',
    categoryExperiencesDesc: 'アートワークショップなど',
    ...
    // File Upload
    uploadTooLarge: 'ファイルサイズは10MB以下にしてください',
    uploadInvalidType: 'JPEG、PNG、WebP、HEIC画像のみ対応しています',
    ...
    applyName: '表示名（公開名）',
    applyNamePlaceholder: 'ニックネームまたは公開名',
    applyLegalName: '本名（法定名）',
    applyLegalNamePlaceholder: '例：山田 花子',
    applyLegalNameNote: '本名はプロフィールに表示されません',
    applyPhone: '電話番号',
    applyPhonePlaceholder: '例：090-1234-5678',
    applyIntro: '自己紹介',
    applyIntroPlaceholder: 'あなたの経験や専門分野について...',
    applyEmail: 'メールアドレス',
    applyEmailPlaceholder: 'email@example.com',
    applyPrivacyNote: '🔒 本名・住所・生年月日・電話番号はプロフィールに表示されません。本人確認のためのみに使用し、第三者への共有は一切行いません。',
    applyStreet: '番地・建物名',
    applyStreetPlaceholder: '例：渋谷1-2-3 ○○ビル101',
    applyCity: '市区町村',
    applyCityPlaceholder: '例：渋谷区',
    applyPrefecture: '都道府県',
    applyCountry: '国',
    applyPostcode: '郵便番号',
    applyPostcodePlaceholder: '例：150-0002',
    applyBirthday: '生年月日',
    applyDobYear: '年',
    applyDobMonth: '月',
    applyDobDay: '日',
    applyDobPrivacy: '生年月日はプロフィールに表示されません',
    applyLocation: '活動エリア（公開）',
    ...
    applyIntroLimit: '文字',
    applySessionCategory: 'カテゴリー',
    applySessionDelivery: '提供方法',
    applySessionLimitReached: 'このプランのセッション上限に達しました',
    ...
    tierFree: '🌱 フリー',
    tierFreeName: 'フリープラン',
    tierFreeDesc: '基本掲載・月1件まで予約受付',
    tierFreePrice: '無料',
    tierStandard: '🌿 スタンダード',
    tierStandardName: 'スタンダードプラン',
    tierStandardDesc: '月3件予約・スケジュール編集',
    tierStandardPrice: '¥1,980/月',
    tierPremium: '🌳 プレミアム',
    tierPremiumName: 'プレミアムプラン',
    tierPremiumDesc: '優先表示・分析機能・スケジュール編集',
    tierPremiumPrice: '¥4,980/月',

    // Tier features
    tierFeatureBasicListing: '基本掲載',
    tierFeature1Booking: '月1件まで予約受付',
    tierFeature1Session: '最大1セッション',
    ...
    tierFeature3Sessions: '最大3セッション',
    tierFeature10Sessions: '最大10セッション',
    tierFeatureUnlimitedSessions: '無制限セッション',
    ...
    dobInvalid: '有効な生年月日を入力してください',
    ageMinor: '18歳未満',
    ageAdult: '18歳以上',
    parentalConsentTitle: '保護者の同意',
    parentalConsentDesc: '18歳未満のお客様は、保護者の同意が必要です。',
    parentalConsentCheck: '保護者の同意を得ています',
    parentalConsentGuardian: '保護者氏名',
    parentalConsentGuardianPlaceholder: '保護者のお名前を入力',
    minorTermsTitle: '未成年者向け利用規約',
    minorTermsContent: '18歳未満の方のご利用について：セッションの予約・参加には保護者の同意が必要です。個人情報の取り扱いには特別な配慮を行います。セラピストは未成年者の受け入れ可否を設定できます。',
    minorTermsAgree: '未成年者向け利用規約に同意します',
    minorBookingBlocked: 'このセラピストは18歳未満のお客様を受け付けていません',
    minorPriceCap: '18歳未満のお客様向けの料金は¥3,000以下に制限されています',
    minorPriceExceeded: 'このセッションは18歳未満の方の料金上限（¥3,000）を超えています',
    // Therapist Minor Settings
    therapistAcceptsMinors: '18歳未満のクライアントを受け入れる',
    therapistMinorTermsTitle: '未成年者セッション規約',
    ...
    settingsAccent: 'アクセント',
    settingsAccentDesc: '自然素材のアクセント効果を選択',
    accentLightWood: '淡い木目',
    accentLightWoodDesc: '檜・薄い杉の優しい雰囲気',
    accentWarmWood: '温かい木目',
    accentWarmWoodDesc: 'やや濃い自然な温もり',
    accentMineral: '鉱物紙',
    accentMineralDesc: '柔らかい石・和紙の質感',
    accentBamboo: '竹',
    accentBambooDesc: '清涼感のある竹の優しさ',
    themeSpring: '🌸 スプリング',
    ...
    dashboardHideAccount: 'アカウントを非表示にする',
    dashboardUnhideAccount: 'アカウントを再表示する',
    dashboardAccountHiddenNote: '現在、あなたのプロフィールは検索結果に表示されていません',
    ...
    profileVisibility: '連絡先の公開設定',
    profileShowEmail: 'メールアドレスをクライアントに公開する',
    profileShowPhone: '電話番号をクライアントに公開する',
    ...
    privacyLastUpdated: '最終更新日: 2026年3月27日',
    termsLastUpdated: '最終更新日: 2026年3月27日',
    privacyIntro: '癒しの庭（以下「当サービス」）は、お客様のプライバシーを尊重し、個人情報の保護に努めます。',
    privacySection1Title: '収集する情報',
    privacySection1: '当サービスは以下の情報を収集します：氏名、メールアドレス、電話番号（任意）、予約履歴、お支払い情報（Stripeを通じて安全に処理）。',
    privacySection2Title: '情報の利用目的',
    privacySection2: '収集した情報は、サービス提供、予約管理、お支払い処理、カスタマーサポート、およびサービス改善のために使用します。',
    privacySection3Title: '情報の共有',
    privacySection3: 'お客様の個人情報は、お客様の同意なく第三者に販売・共有することはありません。セラピストには予約に必要な最小限の情報のみ共有されます。',
    privacySection4Title: 'データの保護',
    privacySection4: 'SSL暗号化、安全なデータベース、アクセス制御を使用してデータを保護しています。お支払い情報はStripeが安全に処理し、当サービスにはカード情報は保存されません。',
    privacySection5Title: 'お問い合わせ',
    privacySection5: 'プライバシーに関するご質問は、アプリ内のフィードバック機能またはメールでお問い合わせください。',
    termsIntro: '本利用規約は、癒しの庭（以下「当サービス」）の利用に関する条件を定めます。当サービスを利用することにより、本規約に同意したものとみなします。',
    termsSection1Title: 'サービスの概要',
    termsSection1: '当サービスは、セラピストとクライアントをつなぐプラットフォームです。セラピストは独立した提供者であり、当サービスの従業員ではありません。',
    termsSection2Title: '予約とキャンセル',
    termsSection2: '予約確定後のキャンセルは、セッション開始24時間前まで無料で可能です。24時間以内のキャンセルについては、キャンセル料が発生する場合があります。',
    termsSection3Title: 'お支払い',
    termsSection3: 'お支払いはStripeを通じて安全に処理されます。料金はセッション予約時に表示される金額となります。',
    termsSection4Title: '禁止事項',
    termsSection4: '不正行為、虚偽情報の提供、他のユーザーへの嫌がらせ、スパム行為は禁止されています。違反した場合、アカウントが停止される場合があります。',
    termsSection5Title: '免責事項',
    termsSection5: '当サービスはプラットフォームとしてセラピストとクライアントをつなぐものであり、セラピストが提供するサービスの品質・結果について保証するものではありません。',
    termsSection6Title: '規約の変更',
    termsSection6: '本規約は必要に応じて変更される場合があります。重要な変更がある場合は、アプリ内で通知します。',

    // Onboarding
    onboardingWelcome: 'ようこそ！癒しの庭へ',
    onboardingStep1: 'セラピストを探す — 気持ちや条件から検索できます',
    onboardingStep2: 'セッションを予約 — 日時を選んで簡単予約',
    onboardingStep3: 'お気に入り・ジャーナル — 体験を記録しましょう',
    onboardingGotIt: 'はじめる',

    // Feedback
    feedbackTitle: 'フィードバック',
    feedbackDesc: 'ベータ版をご利用いただきありがとうございます。ご意見・ご感想をお聞かせください。',
    feedbackPlaceholder: 'ご意見・バグ報告・改善提案など...',
    feedbackSubmit: '送信',
    feedbackThanks: 'フィードバックをいただきありがとうございます！',
    feedbackButton: 'ご意見',
  },
  ...
  en: {
    ...
    categoryPlayful: 'Experiences / Fortune Telling / Retreats',
    categoryPlayfulDesc: 'Fun experiences, fortune telling, and retreats',
    categoryExperiences: 'Experiences',
    categoryExperiencesDesc: 'Art workshop, etc.',
    ...
    // File Upload
    uploadTooLarge: 'File must be under 10MB',
    uploadInvalidType: 'Only JPEG, PNG, WebP, and HEIC images are supported',
    ...
    applyName: 'Display Name (Public)',
    applyNamePlaceholder: 'Nickname or public name',
    applyLegalName: 'Legal / Real Name',
    applyLegalNamePlaceholder: 'e.g., Hanako Yamada',
    applyLegalNameNote: 'Your legal name will not appear on your public profile',
    applyPhone: 'Phone Number',
    applyPhonePlaceholder: 'e.g., 090-1234-5678',
    applyIntro: 'Introduction',
    applyIntroPlaceholder: 'Tell us about your experience and specialties...',
    applyEmail: 'Email',
    applyEmailPlaceholder: 'email@example.com',
    applyPrivacyNote: '🔒 Your legal name, address, date of birth, and phone number will never appear on your public profile. They are used solely for identity verification and will not be shared with anyone.',
    applyStreet: 'Street / Building',
    applyStreetPlaceholder: 'e.g., 1-2-3 Shibuya, Bldg 101',
    applyCity: 'City / Ward',
    applyCityPlaceholder: 'e.g., Shibuya-ku',
    applyPrefecture: 'Prefecture',
    applyCountry: 'Country',
    applyPostcode: 'Postcode',
    applyPostcodePlaceholder: 'e.g., 150-0002',
    applyBirthday: 'Date of Birth',
    applyDobYear: 'Year',
    applyDobMonth: 'Month',
    applyDobDay: 'Day',
    applyDobPrivacy: 'Your date of birth will not appear on your public profile',
    applyLocation: 'Practice Area (Public)',
    ...
    applyIntroLimit: 'characters',
    applySessionCategory: 'Category',
    applySessionDelivery: 'Delivery Method',
    applySessionLimitReached: 'Session limit reached for this plan',
    ...
    tierFreeDesc: 'Basic listing, up to 1 booking/month',
    tierFreePrice: 'Free',
    tierStandard: '🌿 Standard',
    tierStandardName: 'Standard Plan',
    tierStandardDesc: 'Up to 3 bookings/month, schedule editing',
    tierStandardPrice: '¥1,980/mo',
    tierPremium: '🌳 Premium',
    tierPremiumName: 'Premium Plan',
    tierPremiumDesc: 'Priority ranking, analytics, schedule editing',
    tierPremiumPrice: '¥4,980/mo',

    // Tier features
    tierFeatureBasicListing: 'Basic listing',
    tierFeature1Booking: 'Up to 1 booking/month',
    tierFeature1Session: 'Up to 1 session',
    ...
    tierFeature3Sessions: 'Up to 3 sessions',
    tierFeature10Sessions: 'Up to 10 sessions',
    tierFeatureUnlimitedSessions: 'Unlimited sessions',
    ...
    parentalConsentTitle: 'Parental/Guardian Consent',
    parentalConsentDesc: 'Users under 18 require parental or guardian consent.',
    parentalConsentCheck: 'I have obtained parental/guardian consent',
    parentalConsentGuardian: 'Parent/Guardian Name',
    parentalConsentGuardianPlaceholder: 'Enter parent/guardian name',
    minorTermsTitle: 'Terms for Minors',
    minorTermsContent: 'For users under 18: Booking and attending sessions requires parental consent. Special care will be taken with personal information. Therapists may choose whether to accept minor clients.',
    minorTermsAgree: 'I agree to the terms for minors',
    minorBookingBlocked: 'This therapist does not accept clients under 18',
    minorPriceCap: 'Session prices for clients under 18 are limited to ¥3,000',
    minorPriceExceeded: 'This session exceeds the price limit (¥3,000) for clients under 18',
    // Therapist Minor Settings
    therapistAcceptsMinors: 'Accept clients under 18',
    therapistMinorTermsTitle: 'Minor Client Session Terms',
    ...
    settingsAccent: 'Accent Style',
    settingsAccentDesc: 'Natural material accent treatment',
    accentLightWood: 'Light Wood',
    accentLightWoodDesc: 'Hinoki / washed cedar warmth',
    accentWarmWood: 'Warm Wood',
    accentWarmWoodDesc: 'Richer natural warmth',
    accentMineral: 'Mineral',
    accentMineralDesc: 'Soft stone / washi paper',
    accentBamboo: 'Bamboo',
    accentBambooDesc: 'Fresh, calm bamboo green',
    themeSpring: '🌸 Spring',
    ...
    dashboardHideAccount: 'Hide My Account',
    dashboardUnhideAccount: 'Make Account Visible',
    dashboardAccountHiddenNote: 'Your profile is currently hidden from search results',
    ...
    profileShowEmail: 'Show email address to clients',
    profileShowPhone: 'Show phone number to clients',
    ...
    privacyLastUpdated: 'Last updated: March 27, 2026',
    termsLastUpdated: 'Last updated: March 27, 2026',
    privacyIntro: 'Healing Garden ("the Service") respects your privacy and is committed to protecting your personal information.',
    privacySection1Title: 'Information We Collect',
    privacySection1: 'We collect the following information: name, email address, phone number (optional), booking history, and payment information (securely processed through Stripe).',
    privacySection2Title: 'How We Use Your Information',
    privacySection2: 'We use collected information for service delivery, booking management, payment processing, customer support, and service improvement.',
    privacySection3Title: 'Information Sharing',
    privacySection3: 'Your personal information will not be sold or shared with third parties without your consent. Only the minimum information necessary for bookings is shared with therapists.',
    privacySection4Title: 'Data Protection',
    privacySection4: 'We protect your data using SSL encryption, secure databases, and access controls. Payment information is securely processed by Stripe — we never store card details.',
    privacySection5Title: 'Contact Us',
    privacySection5: 'For privacy questions, please use the in-app feedback feature or contact us via email.',
    termsIntro: 'These Terms of Service govern your use of Healing Garden ("the Service"). By using the Service, you agree to these terms.',
    termsSection1Title: 'Service Overview',
    termsSection1: 'The Service is a platform connecting therapists and clients. Therapists are independent providers and are not employees of the Service.',
    termsSection2Title: 'Bookings & Cancellations',
    termsSection2: 'Cancellations are free up to 24 hours before the session start time. Cancellations within 24 hours may incur a cancellation fee.',
    termsSection3Title: 'Payments',
    termsSection3: 'Payments are securely processed through Stripe. Prices are as displayed at the time of booking.',
    termsSection4Title: 'Prohibited Activities',
    termsSection4: 'Fraud, providing false information, harassment of other users, and spamming are prohibited. Violations may result in account suspension.',
    termsSection5Title: 'Disclaimer',
    termsSection5: 'The Service is a platform connecting therapists and clients. We do not guarantee the quality or outcomes of services provided by therapists.',
    termsSection6Title: 'Changes to Terms',
    termsSection6: 'These terms may be updated as needed. Significant changes will be communicated through the app.',

    // Onboarding
    onboardingWelcome: 'Welcome to Healing Garden!',
    onboardingStep1: 'Find a therapist — search by feeling or criteria',
    onboardingStep2: 'Book a session — pick a date and time',
    onboardingStep3: 'Favorites & journal — track your experiences',
    onboardingGotIt: 'Get Started',

    // Feedback
    feedbackTitle: 'Feedback',
    feedbackDesc: 'Thank you for using the beta! We\'d love to hear your thoughts.',
    feedbackPlaceholder: 'Feedback, bug reports, suggestions...',
