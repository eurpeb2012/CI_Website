const translations = {
  ja: {
    ...
    applyPrivacyNote: '🔒 住所・生年月日はプロフィールに表示されません。本人確認のためのみに使用し、第三者への共有は一切行いません。',
    applyAddress: '住所',
  ...
  en: {
    ...
    applyEmail: 'Email',
    applyEmailPlaceholder: 'email@example.com',
    applyPrivacyNote: '🔒 Your address and date of birth will never appear on your public profile. They are used solely for identity verification and will not be shared with anyone.',
